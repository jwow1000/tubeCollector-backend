"""
Django settings for tubecollector project.
...
SECRET_KEY = 'django-insecure-e&ngsoy%(u&*liv$^^)2go1oaku8hpu011ncyvb1(4jxb%&tfw'
...
ROOT_URLCONF = 'tubecollector.urls'
...
WSGI_APPLICATION = 'tubecollector.wsgi.application'
